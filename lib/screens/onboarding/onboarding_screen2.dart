          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                // Subtitle
                Text(
                  "Generate well-structured content with comprehensive charts, graphs, and professional visual data.",
                  style: GoogleFonts.inter(
                    fontSize: 16,
                ...
                _buildFeatureCard(
                  ...
                  description:
                      'Beautiful visualizations that enhance your thesis',
                  delay: 600,
                ),
                const SizedBox(height: 16),
                _buildFeatureCard(
                  ...
                  title: 'Data Tables',
                  description: 'Well-formatted tables with accurate data',
                  delay: 700,
                ),
                const SizedBox(height: 16),
                _buildFeatureCard(
                  ...
                  description: 'Professional statistical representations',
                  delay: 800,
                ),
                const SizedBox(height: 40),
                  ...
                  children: List.generate(3, (index) {
                    return Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        color: index == 1 ? primaryColor : borderColor,
                      ),
                    ).animate().fadeIn(
