...
class _ProcessingScreenState extends State<ProcessingScreen>
  ...
  // Processing stages - updated with visual elements
  final List<String> _processingStages = [
    "Analyzing academic requirements...",
    "Humanizing AI content patterns...",
    "Generating charts and visualizations...",
    "Creating professional data tables...",
    "Structuring thesis with visual elements...",
    "Applying academic formatting...",
    "Finalizing undetectable AI content..."
  ];
  ...
  void _startStageCycle() {
    Future.delayed(const Duration(milliseconds: 1500), () {
      if (mounted) {
        setState(() {
          _currentStageIndex =
              (_currentStageIndex + 1) % _processingStages.length;
        });
        _startStageCycle();
      }
    });
